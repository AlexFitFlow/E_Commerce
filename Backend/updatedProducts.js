let products = [
	...
	},
	{
		...
		price: 49.99,
		description:
			"Access key Halo health metrics like heart rate, Activity points, Sleep score, and on-demand blood oxygen levels on the Halo View color touch display.",
	...
	},
	{
		...
		price: 169.99,
		description:
			"The Title Powerhide Heavybag made of durable powerhide will hold up to your most powerful assault in your home or commercial gym. This heavy bag has a soft 2-inch foam liner providing a comfortable hitting surface for professional and amateur boxers",
	...
	},
	{
		...
		price: 24.95,
		description:
			"Plan your home workout regime with Iron Gym Pull up bars, turn any doorway into a personal gym and get the strong, lean body you always wanted, right at home. It instantly attaches to or removes from your door frame.",
	...
	},
	{
		...
		price: 79.98,
		description:
			"Massage Gun Deep Tissue: 12 massage heads, 7 speed levels. Suitable for muscles of all parts of the body, enjoy deep muscle relaxation. Suitable for back, neck, arm, leg massage.",
	...
	},
	{
		...
		price: 849.99,
		description:
			"ntegrated Brake Lever/Shifters mean controllable braking and shifting in a convenient single unit designed for the road. 6061 Double Butted Aluminum Aero Frame w/ Integrated Headset & Internal Cable.",
	...
	},
	{
		...
		price: 25.99,
		description:
			"The double wall insulation makes the Hydro Flask sweat-free! It keeps your drink COLD for up to 24 hours, and HOT for up to 12 hours",
		extra1: "A Premium Flooring System + Amazing Value for Quality, Performance and Aesthetics",
		extra2: "Traditional Tatami texture provides non-slip traction for grip and dynamic movement",
	...
	},
	{
		...
		price: 8.99,
		description:
			"Made of strong and durable raw material to withstand pressure over time and to last for years. 5 Resistance Levels – This bands allow you to mix and match to get your desired weight level - from 4.5 kg (10lb) up to 45 kg (115lbs) when combined, suitable for someone just starting out or an experienced gym-goer.",
	...
	},
	{
		...
		price: 599.95,
		description:
			"The Gym timer clock is fitted with 2 of the highest grade of super magnets, which can be firmly attached to any metal surface, making them clearly visible during exercise.",
	...
	},
	{
		...
		price: 8.99,
		description:
			"This jump rope is made of steel wires that are coated with strong PVC material, making it durable even after a long time exercising. Its adjustable length design enables you to customize the length according to your needs, making it suitable for everyone, no matter for kids or adults.",
	...
	},
	{
		...
		price: 174.95,
		description:
			"Built to last, built in America. Competitively priced, and precision built. Featuring silver embroidery, this gi is sure to keep your ground game on point. Featuring Fuji's ultralight ATOMIC TWILL GEN 2, this performance-blended fabric is featured on both the jacket top and pants, with a combined weight under 2 lbs.",
	...
	},
	{
		...
		price: 55.95,
		description:
			"Phalanx ultra-lightweight shorts are exactly that, super light! They're also durable enough to hold up perfectly in every day mat training, BJJ competition, and MMA!",
		extra1: "Perfect For: No Gi, Jiu Jitsu, Crossfit, Running, Surfing",
		extra2: "Our unique designs are sublimated which will never crack, fade, or peel, even if you're a two-a-day athlete",
		sizing: "‎7.48 x 4.06 x 1.77 inches - ‎0.13 Kilograms",
		category: "martial arts",
	...
	},
	{
		...
		price: 54.99,
		description:
			"The opening of the backpack is a metal zipper, which is smooth and does not rust.The outer layer is made of waterproof and non-deformable environmentally friendly Oxford cloth material, which is durable. The lining is made of polyester, heat-resistant, wear-resistant, wrinkle-resistant and non-ironing.",
	...
	},
	{
		...
		price: 849.95,
		description:
			"Power Cage combines a weight cage, squat rack, and Cable Crossover Machine which provides a total body workout without switching between different exercise stations. The max weight capacity of this weight cage is up to 1400lbs.",
	...
	},
	{
		...
		price: 149.99,
		description:
			"Worried about the equipment scratching the floor during exercise? This sports pad solves your worries! It has the softness of EVA foam and the firmness of top EPDM rubber layer, preventing floor friction caused by sports equipment, and increasing the service life.",
	...
	},
	{
		...
		price: 11.99,
		description:
			"This Olympic barbell clamp is designed with high-quality solid nylon, which can support heavier weights than the older one but still is lightweight. They are durable and easy to hold heavier loads thanks to the upgraded grip rubber pad design that keep the clips in place.",
	...
	},
	{
		...
		price: 57.99,
		description:
			"Our line of durable snow sleds and discs come in a variety of shapes and sizes to accommodate anyone from kids, experienced sledders, and everyone in between. The high-impact construction and slick bottom will provide you with a fast, smooth ride for many snow seasons.",
	...
	},
	{
		...
		price: 269.99,
		description:
			"One of the best freestyle boards to learn and progress on, the DISTRICT offers easy, friendly fun for entry-level riders. The softer, twin freestyle flex provides an easy-to manipulate ride no matter which direction you slide.",
	...
	},
	{
		...
		price: 249.95,
		description:
			"The Gen 6 Grizzly Trucks have been redesigned from the ground up, incorporating technology perfected in Bear's high end DH and Freeride trucks; game changing strength and highly refined steering geometry are just the tip of the iceberg",
	...
	},
	{
		...
		price: 120.95,
		description:
			"Our Competitor 21.Black Kimono features a Heavyweight Pearl Weave Jacket and  Jacket and Twill Cotton Pant. This staple kimono gives off a fresh look, while maintaining our classic fit.",
	...
	},
	{
		...
		price: 59.95,
		description:
			"Our new long sleeved Ranked Rash Guard is part of the technical series and proudly Made in California. This rash guard showcases our Shoyoroll® original logo on the front, with subtle text on the sleeve.",
	...
	},
	{
		...
		price: 84.95,
		description:
			"Dip stands made of heavy duty steel and supports to 300LBS, durable steel construction provides safety assurance during exercise.",
	...
	},
	{
		...
		price: 2200.95,
		description:
			"Designed for advanced to expert riders who want to go farther and faster on a bike built for superior performance. Suggested rider height range: 5 feet 7 inches - 5 feet 10 inches",
